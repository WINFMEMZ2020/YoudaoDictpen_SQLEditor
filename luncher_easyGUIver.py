...
def initialize():
    ...
    layout = [
        ...
        [sg.Text("dictpen_video_path【词典笔存放视频的文件夹路径】："),sg.In(key='dictpen_video_path_input', default_text=dictpen_video_path), sg.FolderBrowse(button_text="选择文件", target='dictpen_video_path')],
